...
/**
 *  Show a banner telling the user that the specified show has been added to or removed from the push notification list.
 *
 *  @discussion If no name is provided, a standard description will be used.
 */
+ (void)showPushNotificationSubscription:(BOOL)subscribed forShowWithName:(nullable NSString *)name inView:(nullable UIView *)view;
+ (void)showPushNotificationSubscription:(BOOL)subscribed forShowWithName:(nullable NSString *)name inViewController:(nullable UIViewController *)viewController;
